...
public class JobResponse implements org.apache.thrift.TBase<JobResponse, JobResponse._Fields>, java.io.Serializable, Cloneable, Comparable<JobResponse> {
   ...
   * @see JobStatus
   */
  public JobResponse setStatus(JobStatus status) {
    this.status = status;
    return this;
  }
  ...
  public JobResponse setJobStats(JobStats jobStats) {
    this.jobStats = jobStats;
    return this;
  }

  public void unsetJobStats() {
    this.jobStats = null;
  }

  /** Returns true if field jobStats is set (has been assigned a value) and false otherwise */
  public boolean isSetJobStats() {
    return this.jobStats != null;
  }

  public void setJobStatsIsSet(boolean value) {
    if (!value) {
      this.jobStats = null;
    }
  }
  ...
  public JobResponse setExecutionTime(long executionTime) {
  ...
  public boolean equals(JobResponse that) {
    ...
    boolean this_present_jobStats = true && this.isSetJobStats();
    boolean that_present_jobStats = true && that.isSetJobStats();
    if (this_present_jobStats || that_present_jobStats) {
      if (!(this_present_jobStats && that_present_jobStats))
        return false;
      if (!this.jobStats.equals(that.jobStats))
        return false;
    }
  ...
  public int compareTo(JobResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetJobStats()).compareTo(other.isSetJobStats());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetJobStats()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.jobStats, other.jobStats);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, JobResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.jobStats != null) {
        if (struct.isSetJobStats()) {
          oprot.writeFieldBegin(JOB_STATS_FIELD_DESC);
